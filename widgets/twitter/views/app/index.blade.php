...
?>
		<div ng-repeat="entry in home_timeline track by $index" class="list card">
			<div class="item item-avatar" style="padding-bottom:0">
				...
				<p><a href="https://twitter.com/@{{ entry.user.screen_name }}/status/@{{ entry.id_str }}" target="_blank" class="button icon-left ion-ios-clock-outline button-clear button-small">@{{correctTimestring(entry.created_at) | date:'medium'}}</a></p>
			</div>
