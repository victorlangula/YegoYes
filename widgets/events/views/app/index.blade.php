		...
		<div ng-if="events.length > 0">
			<div ng-repeat="entry in events track by $index" class="list card">
				<div class="item item-divider">
					...
					<p><span style="float:left;width:18px;text-align:center"> <i class="ion-calendar"></i></span> @{{correctTimestring(entry.event_start) | date:'mediumDate'}}<span ng-if="entry.event_end != ''"> - @{{correctTimestring(entry.event_end) | date:'mediumDate'}}</span></p>
