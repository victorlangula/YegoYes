...
@section('content')
	<div class="signup-container" style="display:none">
		<div class="signup-header">
			<a href="{{ url('/') }}" class="logo">{{ Lang::get('global.app_title') }}</a>
			<div class="slogan">
				{{ Lang::get('global.app_title_slogan') }}
			</div>
		</div>
        ...
        @endif
				...
				<div class="form-group w-icon">
					<input type="text" name="shop_name" id="shop_name" class="form-control input-lg" placeholder="{{{ Lang::get('confide.shop_name') }}}" data-fv-notempty="true" data-fv-notempty-message="{{ trans('global.please_enter_a_value') }}">
					<span class="fa fa-shopping-cart signup-form-icon"></span>
				</div>				
