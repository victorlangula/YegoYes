    ...
    public static function getHelp($item)
    {
        switch($item)
        {
            ...
            case 'role_owner': 
                ...
                break;
			case 'major': return trans('global.help_major'); break;
			case 'minor': return trans('global.help_minor'); break;
			case 'app_published': return trans('global.help_app_published'); break;
			case 'app_changes': return trans('global.help_app_changes'); break;
